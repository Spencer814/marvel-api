...
//my key
var KEY = "5dc95b35068838b7b155340eaf86a6ba";
...
function getComicData(year) {
	var url = "http://gateway.marvel.com:80/v1/public/comics?format=comic&formatType=comic&noVariants=true&formatType=comic&dateRange="+year+"-01-01%2C"+year+"-12-31&hasDigitalIssue=true&orderBy=issueNumber&apikey="+KEY;
